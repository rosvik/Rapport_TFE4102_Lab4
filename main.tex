...
\begin{abstract}
    ...
    Den første delen av raporten om hanlder teorien bak designet av absoluttverdikretsen. Den påfølgende delen omhandler hvordan vi utførte den praktiske delen som å koblet opp kretsen labben. Deretter diskuter vi resultatene og gir en konklusjon.
    
    
    Raporten er basert på hva som ble gjort i lab 4 den 15. mars 2017 og forarbeidet før labben.
\end{abstract}
...
KRETS-12 (Figur \ref{fig:KRETS-12}) er en kombinasjon av KRETS-1 og KRETS-2, og repressenterer en ferdig 4-bit absoluttverdikrets.
