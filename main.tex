...
Når dette er gjort, kan vi koble sammen 4-bit absoluttverdikretsen og teste hele funksjonaliteten. Portene som skal kobles sammen er
...
Vi kobler om de fire stiftlistparene for å sjekke om de korresponderer med Tabell 3. Nå følger vi med på de to 7-segmentsdisplayene INN og UT for å se input og output.
